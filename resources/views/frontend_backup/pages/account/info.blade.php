...
@section('content')
    <section class="account">
        ...
        @include('frontend_backup.pages.account.sidebar')
                    ...
                    <div class="col col-sm">
                        ...
                        <div class="box-bg-white">
                            <div class="user-sticker">
                                <div class="info">
                                    @if(isset(Auth::guard('frontend_backup')->user()->image))
                                        <div class="avt" id="myAvatar">
                                            <img src="{{ isset(Auth::guard('frontend_backup')->user()->image)?\App\Library\Files::media(Auth::guard('frontend_backup')->user()->image): null }}" />
                                        </div>
                                    @else
                                        <div class="avt" id="myAvatar">
                                    ...
                                    @endif
                                    <div class="summer">
                                        <p><strong>{{ isset(Auth::guard('frontend_backup')->user()->username)?Auth::guard('frontend_backup')->user()->username: null }}</strong></p>
