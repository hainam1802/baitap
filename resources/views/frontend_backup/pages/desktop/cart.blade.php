                    ...
                    <div class="cart-form">
                        <form method="POST" action="/order">
                            ...
                            <div class="row">
                                <div class="col">
                                    @if (auth()->guard('frontend_backup')->check())
                                        <div class="control">
                                            <input type="text" value="{{auth()->guard('frontend_backup')->user()->username}}" readonly />
                                        </div>
                                    @endif
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="control">
                                        <input name="fullname" value="{{isset(auth()->guard('frontend_backup')->user()->fullname) ? auth()->guard('frontend_backup')->user()->fullname : null }}" type="text" placeholder="Họ và tên *" required />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="control">
                                        <input name="phone" type="phone" value="{{isset(auth()->guard('frontend_backup')->user()->phone) ? auth()->guard('frontend_backup')->user()->phone : null }}" placeholder="Số điện thoại *" required />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="control">
                                        @include('frontend_backup.widget.desktop._system_address_provinces')
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="control">
                            ...
                            <div class="row shInfo">
                                <div class="col">
                                    <div class="control">
                                        <input name="email" value="{{isset(auth()->guard('frontend_backup')->user()->email) ? auth()->guard('frontend_backup')->user()->email : null }}" type="email" placeholder="Email" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row shInfo">
