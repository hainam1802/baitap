    ...
    <div class="top-navigation">
        <div class="container">
            <ul>
                ...
                {!! widget('frontend_backup.widget.desktop._menu_top') !!}
                @if(!auth()->guard('frontend_backup')->check())
                    <li><a href="/login" >Đăng nhập</a></li>
                @else

                    <li class="member">
                        <i class="icon-account"></i> <a class="account" href="/account/index"><strong>{{auth()->guard('frontend_backup')->user()->username}}</strong></a>
                        <div class="sub">
                            <ul>
...
{{--                    </div>--}}
    ...
    {!! widget('frontend_backup.widget.desktop._menu') !!}
