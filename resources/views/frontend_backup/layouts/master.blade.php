...
@if (\App\Library\HelpersDevice::isMobile())
    <div class="mobile-wrapper">
            @include('frontend_backup.layouts.includes.mobile.header_navbar')
    <div class="body-content">
@endif

@if (\App\Library\HelpersDevice::isMobile())
    @include('frontend_backup.layouts.includes.mobile.header')
@else
    @include('frontend_backup.layouts.includes.desktop.header')
@endif
...
@if (\App\Library\HelpersDevice::isMobile())
    @include('frontend_backup.layouts.includes.mobile.footer')
@else
    @include('frontend_backup.layouts.includes.desktop.footer')
@endif
@if (\App\Library\HelpersDevice::isMobile())
        </div>
    </div>
