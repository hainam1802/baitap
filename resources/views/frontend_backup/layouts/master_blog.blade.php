...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.css">
{{--    <link rel="stylesheet" href="/assets/frontend_backup/css/desktop/style.css">--}}
{{--    <link rel="stylesheet" href="/assets/frontend_backup/css/desktop/style-detail.css">--}}
{{--    <link rel="stylesheet" href="/assets/frontend_backup/css/desktop/account.css">--}}
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
{{--    <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.1.3/assets/owl.carousel.min.css'>--}}
{{--    <link rel="preload" as="script"  href="/assets/frontend_backup/js/desktop/action.js">--}}
...
<body>
    <div id="td-outer-wrap" class="td-theme-wrap">
        @include('frontend_backup.layouts.includes.header_news')
            @yield('content')
        @include('frontend_backup.layouts.includes.footer_news')
    </div>
    {!! setting('sys_message') !!}
</body>
