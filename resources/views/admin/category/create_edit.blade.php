...
@section('content')
@if(isset($data))
{{Form::open(array('route'=>array('admin.category.update',$data->id),'method'=>'PUT','id'=>'formMain','enctype'=>"multipart/form-data" , 'files' => true))}}
@else
{{Form::open(array('route'=>array('admin.category.store'),'method'=>'POST','id'=>'formMain','enctype'=>"multipart/form-data"))}}
@endif
<div class="row">
   <div class="col-lg-9">
         ...
         <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-6 col-md-6">
                    <label for="name">{{ __('Tên khu ở')}} <span style="color: red">(*)</span></label>
                    <input type="text" name="title"
                    value="{{ old('title', isset($data) ? $data->title : null) }}"
                    placeholder="{{ __('Tên khu ở') }}"  autocomplete="off" id="title_gen_slug"
...
{{--                    {{Form::select('type',config('module.category.type'),old('type', isset($data) ? $data->type : null),array('class'=>'form-control'))}}--}}
{{--                    @if($errors->has('type'))--}}
