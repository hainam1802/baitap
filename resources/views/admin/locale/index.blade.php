...
@section('action_area')
    <ol class="d-flex justify-content-end pr-3">
        <div class="btn-group mt-3">
            <a href="{{route('admin.locale.create')}}" type="button" class="btn btn-success font-weight-bolder mr-3">
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array('admin.locale.destroy',0),'class'=>'form-horizontal','id'=>'form-delete','method'=>'DELETE'))}}
        ...
        var KTDatatablesDataSourceAjaxServer = function () {
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    "order": [[1, "desc"]],
                    ajax: {
                        url: '{{route("admin.locale.index")}}' + '?ajax=1',
                        type: 'GET',
                        data: function (d) {
                            d.id = $('#id').val();
                            d.name = $('#name').val();
                    ...
                    columns: [
                        {data: 'id', title: 'ID'},
                        {
                            data: 'title', title: '{{__('Tên địa điểm')}}',
