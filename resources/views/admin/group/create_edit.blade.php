...
@section('content')
@if(isset($data))
{{Form::open(array('route'=>array('admin.group.update',$data->id),'method'=>'PUT','id'=>'formMain','enctype'=>"multipart/form-data" , 'files' => true))}}
@else
{{Form::open(array('route'=>array('admin.group.store'),'method'=>'POST','id'=>'formMain','enctype'=>"multipart/form-data"))}}
@endif
<div class="row">
   <div class="col-lg-9">
      <div class="card card-custom gutter-b">
         <div class="card-header">
            <div class="card-title">
               <h3 class="card-label">
                  Cấu hình kiểu phòng <i class="mr-2"></i>
               </h3>
            </div>
         </div>
         <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-6 col-md-6">
                    <label for="name">{{ __('Tên kiểu phòng')}} <span style="color: red">(*)</span></label>
                    <input type="text" name="title"
                    value="{{ old('title', isset($data) ? $data->title : null) }}"
                    placeholder="{{ __('Tên kiểu phòng') }}"  autocomplete="off" id="title_gen_slug"
...
{{--                    {{Form::select('type',config('module.group.type'),old('type', isset($data) ? $data->type : null),array('class'=>'form-control'))}}--}}
{{--                    @if($errors->has('type'))--}}
