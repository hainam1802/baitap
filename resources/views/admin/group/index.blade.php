...
@section('action_area')
    <ol class="d-flex justify-content-end pr-3">
        <div class="btn-group mt-3">
            <a href="{{route('admin.group.create')}}" type="button" class="btn btn-success font-weight-bolder mr-3">
...
@section('content')
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array('admin.group.destroy',0),'class'=>'form-horizontal','id'=>'form-delete','method'=>'DELETE'))}}
    ...
    <div class="modal fade" id="addModel">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array('admin.group.store'),'class'=>'form-horizontal','id'=>'form-add','method'=>'POST','enctype'=>"multipart/form-data" , 'files' => true))}}
        ...
        var KTDatatablesDataSourceAjaxServer = function () {
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    "order": [[1, "desc"]],
                    ajax: {
                        url: '{{route("admin.group.index")}}' + '?ajax=1',
                        type: 'GET',
                        data: function (d) {
                            d.id = $('#id').val();
                            d.name = $('#name').val();
                    ...
                    columns: [
                        {data: 'id', title: 'ID'},
                        {
                            data: 'title', title: '{{__('Tên kiểu phòng')}}',
